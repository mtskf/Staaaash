...
**Important**: When available, use `mcp__github_inline_comment__create_inline_comment` to add comments directly on specific code lines where test coverage is lacking. Otherwise, format feedback as inline-style comments in your report.
