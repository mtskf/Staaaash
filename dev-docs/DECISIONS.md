...
- Context: Firebase Realtime Database SDK conflicts with Manifest V3 CSP.
- Decision: Use the Realtime Database REST API for data sync and keep Firebase Auth SDK for login.
- Consequences:
...
- Decision: Store Last Synced State (Base) and do a 3-way merge.
- Logic:
...
- Context: Remote-only resolution lost local edits.
...
- Decision: Use shadcn/ui patterns with Tailwind CSS and Radix UI.
